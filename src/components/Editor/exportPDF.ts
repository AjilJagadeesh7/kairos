export function exportPDF(editorRoot: HTMLElement | null, noteTitle: string): void {
...
<head>
  ...
  <style>
    body{font-family:Georgia,'Times New Roman',serif;max-width:780px;margin:48px auto;padding:0 24px;color:#1a1a1a;line-height:1.7}
    ...
    .milkdown-code-block .cm-scroller{overflow:visible}
    ...
    .preview-panel .preview{display:block}
    table{border-collapse:collapse;width:100%;margin:1em 0;table-layout:auto}
    td,th{border:1px solid #ccc;padding:4px 10px;text-align:left;vertical-align:middle;white-space:normal}
    ...
    .milkdown-image-block .image-wrapper{display:block}
