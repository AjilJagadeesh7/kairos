...
export function OnboardingModal() {
  ...
  const navButtons = (showBack = true) => (
    <div className="flex gap-3">
      ...
      <button onClick={next} className="flex flex-[2] items-center justify-center gap-2 rounded-xl bg-[rgb(var(--accent))] px-6 py-3 text-sm font-semibold text-[rgb(var(--accent-fg))] transition hover:opacity-90">
        ...
        <div key={step} style={{ animation: 'onboard-step-in 0.28s ease both' }}>
          ...
          {step === 0 && (
            <div className="px-8 pb-8 pt-12 text-center">
              ...
              <h1 className="mb-2 text-2xl font-black tracking-tight text-[rgb(var(--text))]">Welcome to MindVault</h1>
            ...
            <div className="px-8 pb-8 pt-12">
              ...
              <div className="mb-4 flex flex-col gap-3">
                ...
                <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-4">
                  ...
                  <p className="mb-3 text-[11px] leading-relaxed text-[rgb(var(--text-3))]">
                    Add <code className="rounded bg-[rgb(var(--surface-2))] px-1 py-0.5 font-mono text-[rgb(var(--accent))]">!</code> before brackets to embed a note's full content live.
                  </p>
                  <div className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--surface))] px-3 py-2 font-mono text-xs">
              ...
              <div className="mb-4 flex flex-col gap-3">
                <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-4">
                  ...
                  <p className="text-[11px] leading-relaxed text-[rgb(var(--text-3))]">
                    Drop notes, free-form text, and web pages onto an infinite canvas. Draw connections and arrange ideas spatially.
                  </p>
                ...
                <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--bg))] p-4">
                  ...
                  <p className="text-[11px] leading-relaxed text-[rgb(var(--text-3))]">
                    Every note is a node. Wikilinks, shared tags, and semantic similarity become edges. The more you write, the richer the map.
                  </p>
                </div>
              </div>
              {navButtons()}
