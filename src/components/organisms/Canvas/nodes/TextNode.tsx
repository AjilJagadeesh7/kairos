...
export function TextNode({ id, data, selected }: NodeProps & { data: TextNodeData }) {
  ...
  return (
    <div className={`relative flex h-full min-h-[120px] min-w-[200px] flex-col overflow-hidden rounded-xl border bg-[rgb(var(--surface))] shadow-md transition-shadow ${
    ...
    >
      <NodeResizer minWidth={200} minHeight={120} isVisible={selected} lineStyle={{ borderColor: 'rgb(var(--accent))' }} handleStyle={{ borderColor: 'rgb(var(--accent))' }} />
